...
export function ContactSection() {
  return (
    <section id="contacto" className="px-6 py-20 lg:px-8 lg:py-24">
      <div className="mx-auto grid w-full max-w-7xl gap-10 rounded-4xl border border-white/10 bg-linear-to-br from-[#101841] to-[#0b113a] p-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:p-10">
