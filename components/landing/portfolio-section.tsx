      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-12">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {siteData.portfolio.items.map((project) => (
            <article
              key={project.title}
              className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-linear-to-br from-[#0c1338] via-[#13215a] to-[#1d4ed8] hover:shadow-xl hover:shadow-cyan-500/50 hover:ring-cyan-500"
            >
